...
#כדי להוסיף הרשאות לתיבת מייל כלשהי, יש להתשמש בפקודה הבאה:
#Add-MailboxPermission –Identity ??????@compedia.net –User Lielc@compedia.net –AccessRights FullAccess –InheritanceType All –Automapping $false
#כדי למחוק הרשאות מתיבל מייל כלשהי יש להשתמש בפקודה הבאה:
#Remove-MailboxPermission -Identity ilang@compedia.net -User Lielc@compedia.net -AccessRights FullAccess -InheritanceType All
